...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    protected void onPause(){
        music.stop();
        music.release(); // stop playing sound if we exit the app.
        super.onPause();
    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuSquare:
                ...
                return true;
            case R.id.menuHatch:
                Toast.makeText(this, "Hatch Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.Hatch);
                return true;
        }
        return false;
    }
    ...
    public void onButtonClickSaveImage(View v){
        ...
        MediaStore.Images.Media.insertImage(getContentResolver(), _impressionistView.getOffScreenBitmap(), "Impressionism", "A work of art");
    }


    private boolean musicPlaying = false;
    public void onButtonClickMusic(View v){
        if (musicPlaying) {
            music.pause();
        } else {
            music.start();
    ...
    public void onCheckedDynamicSize(View v){
        _impressionistView.setDynamicMode(((CheckBox) v).isChecked());
    }
